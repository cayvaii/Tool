...
local SimpleSpy3 = Create("ScreenGui",{Name = "SimpleSpy Edit By cayvaii",ResetOnSpawn = false})
local Storage = Create("Folder",{})
local Background = Create("Frame",{Parent = SimpleSpy3,Name = "Background",BackgroundColor3 = Color3.new(1, 1, 1),BackgroundTransparency = 1,Position = UDim2.new(0, 160, 0, 100),Size = UDim2.new(0, 450, 0, 268)})
...
UserInputService9897.InputChanged:Connect(function(input)
    if input == dragInput9897 and dragging9897 then
        update9897(input)
    end
end)
